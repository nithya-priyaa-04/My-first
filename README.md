...
<body>
    ...
    <section id="about">
        <div class="section-content">
            <h2>About Me</h2>
            <p>I'm a <b>BSC Computer Science Student In Ambedkar Clg</b>expert who is passionate about creating dynamic and user-friendly websites. 
...
<body>
    <header>
        <div class="header-content">
            <!-- Add your profile picture here -->
            <img src=".jpg" alt="Your Profile Picture" class="profile-picture">
            <h1>S.PINKLY</h1>
            <p>BSC Computer Science</p>
        </div>
    </header>
